...
namespace XLua
{
    public partial class DelegateBridge : DelegateBridgeBase
    {
		...
		public void __Gen_Delegate_Imp6(int p0, bool p1)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public void __Gen_Delegate_Imp9(UnityEngine.Collider p0, UnityEngine.Vector3 p1)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public void __Gen_Delegate_Imp10(int p0, int p1)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public void __Gen_Delegate_Imp12(UnityEngine.Object p0, UnityEngine.Object p1)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public void __Gen_Delegate_Imp13(string p0, UnityEngine.Texture p1)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public void __Gen_Delegate_Imp14(string p0, UnityEngine.Transform p1)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public CAE.Core.ILuaPanelMgr __Gen_Delegate_Imp16()
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
                ...
                CAE.Core.ILuaPanelMgr __gen_ret = (CAE.Core.ILuaPanelMgr)translator.GetObject(L, errFunc + 1, typeof(CAE.Core.ILuaPanelMgr));
                LuaAPI.lua_settop(L, errFunc - 1);
                return  __gen_ret;
#if THREAD_SAFE || HOTFIX_ENABLE
            }
		...
		public override Delegate GetDelegateByType(Type type)
		{
			...
			{
			    return new System.Action<int, bool>(__Gen_Delegate_Imp6);
			}
		
		    if (type == typeof(System.Action<bool, float>))
			{
			    return new System.Action<bool, float>(__Gen_Delegate_Imp7);
			}
		
		    if (type == typeof(System.Action<UnityEngine.Vector2>))
			{
			    return new System.Action<UnityEngine.Vector2>(__Gen_Delegate_Imp8);
			}
		
		    if (type == typeof(System.Action<UnityEngine.Collider, UnityEngine.Vector3>))
			{
			    return new System.Action<UnityEngine.Collider, UnityEngine.Vector3>(__Gen_Delegate_Imp9);
			}
		
		    if (type == typeof(UnityEngine.Events.UnityAction<int, int>))
			{
			    return new UnityEngine.Events.UnityAction<int, int>(__Gen_Delegate_Imp10);
			}
		
		    if (type == typeof(UnityEngine.Events.UnityAction<UnityEngine.EventSystems.PointerEventData>))
			{
			    return new UnityEngine.Events.UnityAction<UnityEngine.EventSystems.PointerEventData>(__Gen_Delegate_Imp11);
			}
		
		    if (type == typeof(System.Action<UnityEngine.Object, UnityEngine.Object>))
			{
			    return new System.Action<UnityEngine.Object, UnityEngine.Object>(__Gen_Delegate_Imp12);
			}
		
		    if (type == typeof(System.Action<string, UnityEngine.Texture>))
			{
			    return new System.Action<string, UnityEngine.Texture>(__Gen_Delegate_Imp13);
			}
		
		    if (type == typeof(System.Action<string, UnityEngine.Transform>))
			{
			    return new System.Action<string, UnityEngine.Transform>(__Gen_Delegate_Imp14);
			}
		    ...
		    if (type == typeof(CAE.Core.NewLuaPanelMgr))
			{
			    return new CAE.Core.NewLuaPanelMgr(__Gen_Delegate_Imp16);
			}
