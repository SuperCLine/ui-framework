...
namespace XLua.CSObjectWrap
{
    public class XLua_Gen_Initer_Register__
	{
        ...
        static void wrapInit1(LuaEnv luaenv, ObjectTranslator translator)
        {
            ...
            translator.DelayWrapLoader(typeof(CAE.Core.PanelMgr), CAECorePanelMgrWrap.__Register);
        
        
            translator.DelayWrapLoader(typeof(CAE.Core.UILoopGrid), CAECoreUILoopGridWrap.__Register);
        ...
        static void Init(LuaEnv luaenv, ObjectTranslator translator)
        {
            ...
            translator.AddInterfaceBridgeCreator(typeof(CAE.Core.ILuaPanelItem), CAECoreILuaPanelItemBridge.__Create);
            
            translator.AddInterfaceBridgeCreator(typeof(CAE.Core.ILuaPanelMgr), CAECoreILuaPanelMgrBridge.__Create);
