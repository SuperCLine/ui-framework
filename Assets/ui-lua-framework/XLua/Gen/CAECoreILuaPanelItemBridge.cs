...
{
    public class CAECoreILuaPanelItemBridge : LuaBase, CAE.Core.ILuaPanelItem
    {
	    public static LuaBase __Create(int reference, LuaEnv luaenv)
		{
		    return new CAECoreILuaPanelItemBridge(reference, luaenv);
		}
		
		public CAECoreILuaPanelItemBridge(int reference, LuaEnv luaenv) : base(reference, luaenv)
        {
        }
		...
		void CAE.Core.ILuaPanelItem.OnShow()
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		void CAE.Core.ILuaPanelItem.OnHide()
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		void CAE.Core.ILuaPanelItem.OnClose()
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		void CAE.Core.ILuaPanelItem.OnClick(UnityEngine.Component btn)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		void CAE.Core.ILuaPanelItem.OnInputValueChanged(UnityEngine.Component input, string val)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		void CAE.Core.ILuaPanelItem.OnInputEndEdit(UnityEngine.Component input, string val)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		void CAE.Core.ILuaPanelItem.OnToggleValueChanged(UnityEngine.Component tog, bool val)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		void CAE.Core.ILuaPanelItem.OnSliderValueChanged(UnityEngine.Component slider, float val)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		void CAE.Core.ILuaPanelItem.OnDown(UnityEngine.GameObject go)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		void CAE.Core.ILuaPanelItem.OnUp(UnityEngine.GameObject go)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		void CAE.Core.ILuaPanelItem.OnEnter(UnityEngine.GameObject go)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		void CAE.Core.ILuaPanelItem.OnExit(UnityEngine.GameObject go)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		void CAE.Core.ILuaPanelItem.OnLongPressStart(UnityEngine.GameObject go)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		void CAE.Core.ILuaPanelItem.OnLongPress(UnityEngine.GameObject go)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		void CAE.Core.ILuaPanelItem.OnLongPressEnd(UnityEngine.GameObject go)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		void CAE.Core.ILuaPanelItem.OnDragStart(UnityEngine.GameObject go, UnityEngine.EventSystems.PointerEventData eventData)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		void CAE.Core.ILuaPanelItem.OnDrag(UnityEngine.GameObject go, UnityEngine.EventSystems.PointerEventData eventData)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		void CAE.Core.ILuaPanelItem.OnDragEnd(UnityEngine.GameObject go, UnityEngine.EventSystems.PointerEventData eventData)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
